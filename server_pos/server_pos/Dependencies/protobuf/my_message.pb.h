...
class MyMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  // int32 idd = 1;
  void clear_idd();
  ::PROTOBUF_NAMESPACE_ID::int32 idd() const;
  void set_idd(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_idd() const;
  void _internal_set_idd(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 idd_;
  float value_;
...
// int32 idd = 1;
inline void MyMessage::clear_idd() {
  idd_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MyMessage::_internal_idd() const {
  return idd_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MyMessage::idd() const {
  // @@protoc_insertion_point(field_get:MyMessage.idd)
  return _internal_idd();
}
inline void MyMessage::_internal_set_idd(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  idd_ = value;
}
inline void MyMessage::set_idd(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_idd(value);
  // @@protoc_insertion_point(field_set:MyMessage.idd)
}
...
// float value = 3;
inline void MyMessage::clear_value() {
  value_ = 0;
}
inline float MyMessage::_internal_value() const {
  return value_;
}
inline float MyMessage::value() const {
  // @@protoc_insertion_point(field_get:MyMessage.value)
  return _internal_value();
}
inline void MyMessage::_internal_set_value(float value) {
  
  value_ = value;
}
inline void MyMessage::set_value(float value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:MyMessage.value)
}
